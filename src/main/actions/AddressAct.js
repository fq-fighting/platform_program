...
const actions = {
    ...
    Address: (data) =>(dispatch,getState)=>{
        ...
        // let state = getState()[ADDRESSREDU].setIn(['address','addressCode'], "dfdfdfdfd");
        // let REDU = getState()[ADDRESSREDU].toJS();
        // REDU.address = data;
        // dispatch({ type: ADDRESSREDU, state: fromJS(REDU) });
        let state = getState()[ADDRESSREDU];
        let mstate = state.toJS();
        mstate.detail = data;
        // let state = getState()[ADDRESSREDU].set('detail', data);
